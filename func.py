...
class StudiKasus2:
    ...
    def import_csv(self, path):
        ...
        """
        global df
        df = pd.read_csv(path, index_col=False, delimiter=',', encoding='latin1', on_bad_lines='skip')
    ...
    def load_data(self, db_name, table_name):
        ...
        try:
            ...
            print("Error while connecting to MySQL", e)import mysql.connector as mysql
from mysql.connector import Error
import sqlalchemy
import pandas as pd
